...
export default function Toast({success, message}: IProps) {
  return (
    <div id="toast-success" className="flex items-center fixed top-20 shadow-2xl shadow-black z-20 p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg dark:text-gray-400 dark:bg-gray-800" role="alert">
    {success ?<div className="inline-flex flex-shrink-0 justify-center items-center w-8 h-8 text-green-500 bg-green-100 rounded-lg dark:bg-green-800 dark:text-green-200">
